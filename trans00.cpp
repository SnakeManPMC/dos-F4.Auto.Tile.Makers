...
typedef tagRGBQUAD Matriz24bpp[tilewidth][tilewidth];
...
int main()
{
  ...
  */
  ...
  static CRaster bmp_temp;  //El fichero bmp donde se van a guardar las transiciones en 24bpp
